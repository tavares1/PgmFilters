...
def constrat(data,value_contrast):
    ...
    for x in range(0, height):
        for y in range(0, width):
            # Calculando o valor máximo de contrante do pixel, caso o valor calculado seja maior que 255, retornamos o 255, valor máximo do pixel.
            max_contrast = data[x][y] + data[x][y] * 10 / 100 if data[x][y] + data[x][y] * 10 / 100 < 255 else 255
            # Calculando o valor mínimo de contrante do pixelm, caso o valor calculado seja menor que 0, retornamos 0, valor minimo.
